...
AuthorSchema.static("findAuthorWithArticles", function (id) {
    return __awaiter(this, void 0, void 0, function () {
        var author;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, this.findById(id).populate("articles")];
                case 1:
                    author = _a.sent();
...
AuthorSchema.statics.checkCredentials = function (email, pw) {
    return __awaiter(this, void 0, void 0, function () {
        var user, isMatch;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    console.log(user);
                    return [4 /*yield*/, bcrypt_1.default.compare(pw, user.password)];
                case 2:
                    isMatch = _a.sent();
                    if (isMatch)
...
AuthorSchema.methods.toJSON = function () {
    ...
    var _userObject = Object.assign({}, userObject);
